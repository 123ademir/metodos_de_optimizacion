...
\begin{center}
{\LARGE \textbf{Optimización de Precios en Servicios de Ride-Sharing mediante Técnicas Metaheurísticas: Aplicación del Algoritmo Simulated Annealing}}
\vspace{0.5cm}

{\large Autor: Nestor Ademir Ruelas Yana}\\
{\large 75670692@est.unap.edu.pe}\\
{\large \url{https://github.com/123ademir/metodos_de_optimizacion}}
\end{center}
\vspace{1cm}
\end{@twocolumnfalse}
]
